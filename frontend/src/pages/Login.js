...
const Login = ({ setIsLoggedIn }) => {
  ...
  // ✅ DEFINE THESE FIRST — before any useEffect that uses them
  ...
  // ✅ NOW the useEffects — startCamera and handleStudentLogin are already defined

  useEffect(() => {
    if (role !== "student") return;
    const step = state.current.step;
    if (step === "welcome") speak("Welcome. Hold the space bar and say your username.");
